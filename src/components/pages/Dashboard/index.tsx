	...
	const getEvents = async () => {
		try {
			const res = await axios.get(`http://localhost:3000/event/user/86dde15c-32d5-48b9-a811-aeee57cd8555`, {
				headers: {
					'Authorization': 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiI4NmRkZTE1Yy0zMmQ1LTQ4YjktYTgxMS1hZWVlNTdjZDg1NTUiLCJlbWFpbCI6ImJvcmdlc0BkZXYuY29tIiwiaWF0IjoxNjY4Njg5ODMxLCJleHAiOjE2Njg3NDk4MzF9.H2_JiYOLt5wVcxe3C31o2mC-i6tN3AtE-MAp0xDfU0c'
				},
				params: {},
			});
			setEvents(res.data);
